...
describe('Library', () => {
  ...
  describe('EnumerableSetAdd', () => {
    it('should work when adding and adding multiple times', async () => {
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetAdd(3)
      );
      expect(await dolomiteMargin.contracts.callConstantContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetLength()
      )).to.eql('1');
  ...
  describe('EnumerableSetRemove', () => {
    it('should work when removing and removing multiple times', async () => {
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetAdd(3)
      );
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetAdd(4)
      );
      expect(await dolomiteMargin.contracts.callConstantContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetLength()
      )).to.eql('2');
      ...
      // Doesn't add a duplicate
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetRemove(3)
      );
      expect(await dolomiteMargin.contracts.callConstantContractFunction(
        dolomiteMargin.contracts.testLib.methods.EnumerableSetLength()
      )).to.eql('1');
  ...
  describe('TypedSignature', () => {
    ...
    describe('recover', () => {
      ...
      it('succeeds for no prepend', async () => {
        ...
        expect(recoveredAddress).to.eql(signer);
      });
  ...
  describe('Require', () => {
    ...
    it('that (1 bytes32, 2 numbers)', async () => {
      ...
      await dolomiteMargin.contracts.testLib.methods.RequireNotThatB2(reason2, bytes32Hex, arg1, arg3).call();
    });
  });
  ...
  describe('Time', () => {
    it('currentTime', async () => {
      ...
      expect(new BigNumber(time1).toNumber()).to.eql(block1.timestamp);
      expect(new BigNumber(time2).toNumber()).to.eql(block2.timestamp);
      expect(block2.timestamp).to.be.greaterThan(block1.timestamp + 15);
    });
  });
  ...
  describe('Token', () => {
    ...
    before(async () => {
      ...
      malformed = dolomiteMargin.contracts.malformedToken.options.address;
    ...
    it('transfer (normal)', async () => {
      ...
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransfer(token, addr, amount),
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(token, addr).call();
      expect(result).to.eql(amount);
    });

    it('transfer (malformed)', async () => {
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.malformedToken.methods.issueTo(libAddr, amount),
      );
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransfer(malformed, addr, amount),
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(malformed, addr).call();
      expect(result).to.eql(amount);
    });
    ...
    it('transfer (omise)', async () => {
      ...
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransfer(omise, addr, amount),
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(omise, addr).call();
      expect(result).to.eql(amount);
    });
    ...
    it('transferFrom (normal)', async () => {
      ...
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransferFrom(token, owner, addr, amount),
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(token, addr).call();
      expect(result).to.eql(amount);
    });
    ...
    it('transferFrom (malformed)', async () => {
      await Promise.all([
        dolomiteMargin.contracts.callContractFunction(
          dolomiteMargin.contracts.malformedToken.methods.issueTo(owner, amount),
        ),
        dolomiteMargin.contracts.callContractFunction(
          dolomiteMargin.contracts.malformedToken.methods.approve(libAddr, amount),
          { from: owner },
        ),
      ]);
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransferFrom(malformed, owner, addr, amount)
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(malformed, addr).call();
      expect(result).to.eql(amount);
    });
    ...
    it('transferFrom (omise)', async () => {
      ...
      await dolomiteMargin.contracts.callContractFunction(
        dolomiteMargin.contracts.testLib.methods.TokenTransferFrom(omise, owner, addr, amount),
      );
      result = await dolomiteMargin.contracts.testLib.methods.TokenBalanceOf(omise, addr).call();
      expect(result).to.eql(amount);
    });
  ...
  describe('Types', () => {
    ...
    it('zeroPar', async () => {
      ...
      expect(result.value).to.eql(zero);
    });
