...
describe('Withdraw', () => {
  ...
  it('Succeeds for events', async () => {
    ...
    expect(withdrawLog.name).to.eql('LogWithdraw');
    expect(withdrawLog.args.accountOwner).to.eql(who);
    expect(withdrawLog.args.accountNumber).to.eql(accountNumber);
...
async function expectBalances(
  ...
  expect(operatorTokenBalance).to.eql(operatorWei);
}
