...
library Exchange {
    ...
    function transferOut(
        ...
        internal
    {
        if (!deltaWei.isPositive()) { /* FOR COVERAGE TESTING */ }
        Require.that(!deltaWei.isPositive(),
            FILE,
    ...
    function transferIn(
        ...
        internal
    {
        if (!deltaWei.isNegative()) { /* FOR COVERAGE TESTING */ }
        Require.that(!deltaWei.isNegative(),
            FILE,
    ...
    {
        if (!desiredAmount.isNegative()) { /* FOR COVERAGE TESTING */ }
        Require.that(!desiredAmount.isNegative(),
            FILE,
    ...
    function exchange(
        ...
        returns (Types.Wei memory)
    {
        if (!requestedFillAmount.isPositive()) { /* FOR COVERAGE TESTING */ }
        Require.that(!requestedFillAmount.isPositive(),
            FILE,
