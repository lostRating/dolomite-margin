...
library Storage {
        ...
        returns (Monetary.Price memory)
    {
        ...
        if (price.value != 0) { /* FOR COVERAGE TESTING */ }
        Require.that(price.value != 0,
            FILE,
        ...
        returns (bool)
    {
        ...
        if (requireMinBorrow) {
            ...
            Require.that(borrowValue.value >= state.riskParams.minBorrowedValue.value,
                FILE,
        ...
        view
    {
        ...
        if (isValidOperator) { /* FOR COVERAGE TESTING */ }
        Require.that(isValidOperator,
            FILE,
        ...
        returns (Types.Par memory, Types.Wei memory)
    {
        ...
        if (!oldPar.isPositive()) { /* FOR COVERAGE TESTING */ }
        Require.that(!oldPar.isPositive(),
            FILE,
        ...
        if (!deltaWei.isNegative() && oldPar.value >= newPar.value) { /* FOR COVERAGE TESTING */ }
        Require.that(!deltaWei.isNegative() && oldPar.value >= newPar.value,
            FILE,
    ...
    function initializeCache(
        ...
        if (cache.marketsLength == counter) { /* FOR COVERAGE TESTING */ }
        Require.that(cache.marketsLength == counter,
            FILE,
