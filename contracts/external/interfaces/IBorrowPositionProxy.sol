...
interface IBorrowPositionProxy {
    ...
    event BorrowPositionOpen(address indexed _borrower, uint indexed _accountIndex);
     ...
     * @param _marketIds            The IDs of the markets being withdrawn, to close the position
     */
    function closeBorrowPosition(
        uint _borrowAccountIndex,
        uint _toAccountIndex,
        uint[] calldata _marketIds
    ) external;
